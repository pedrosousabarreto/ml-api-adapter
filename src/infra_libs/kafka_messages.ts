...
export interface IEventStoreMessageHeader{
	...
	msg_schema_version:number // command or event payload structure version
	...
	entity_version:number; // which entity version this command should be executed or event should be applied to
}
